...
{
    public class clEspecialidadTituloProfesor
    {
        #region Atributos
        ...
        **/
        ...
        {
            strSentencia = "Select * from tbEspecialidadesProf";
        ...
        **/
        ...
        {
            strSentencia = "Insert into tbEspecialidadTituloProfesor ( idEspecialidaTitulo,idProfesor) values('" +
        ...
        **/
        ...
        {
            strSentencia = "Delete * from tbEspecialidadesProf where idProfesor = " +
